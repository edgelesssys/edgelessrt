...
wget https://github.com/edgelesssys/edgelessrt/releases/download/v0.2.10/edgelessrt_0.2.10_amd64.deb
sudo apt install ./edgelessrt_0.2.10_amd64.deb build-essential libssl-dev
