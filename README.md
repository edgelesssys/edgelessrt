...
wget https://github.com/edgelesssys/edgelessrt/releases/download/v0.3.3/edgelessrt_0.3.3_amd64.deb
sudo apt install ./edgelessrt_0.3.3_amd64.deb build-essential libssl-dev
