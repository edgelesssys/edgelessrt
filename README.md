...
wget https://github.com/edgelesssys/edgelessrt/releases/download/v0.2.8/edgelessrt_0.2.8_amd64.deb
sudo apt install ./edgelessrt_0.2.8_amd64.deb build-essential libssl-dev
