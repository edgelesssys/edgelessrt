...
wget https://github.com/edgelesssys/edgelessrt/releases/download/v0.2.0/edgelessrt_0.2.0_amd64.deb
sudo apt install ./edgelessrt_0.2.0_amd64.deb build-essential libssl-dev
