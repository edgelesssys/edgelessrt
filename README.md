...
wget https://github.com/edgelesssys/edgelessrt/releases/download/v0.3.4/edgelessrt_0.3.4_amd64.deb
sudo apt install ./edgelessrt_0.3.4_amd64.deb build-essential libssl-dev
